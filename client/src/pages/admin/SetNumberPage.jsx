...
export default function SetNumberPage() {
  ...
  // 🔒 Cek login admin & ambil nomor WhatsApp
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex bg-[#0a0a0a] text-white">
      ...
      {/* Main Content */}
      <main className="flex-1 p-6 md:p-10 bg-gradient-to-br from-black via-[#1a0f00] to-[#220000] flex flex-col items-center">
        <h1 className="text-3xl font-bold text-orange-400 mb-8 text-center md:text-left w-full md:w-auto">
          Set Nomor WhatsApp Admin
        </h1>

        <form
          onSubmit={handleSubmit}
          className="bg-[#111] p-8 rounded-2xl border border-[#222] shadow-lg w-full max-w-md"
        >
